...
export class REST {
  ...
  public post(route: string, body: any | undefined = undefined) {
    return this.request({ method: "POST", route, body });
  }

  public put(route: string, body: any | undefined = undefined) {
    return this.request({ method: "PUT", route, body });
  }

  public delete(route: string, body: any | undefined = undefined) {
